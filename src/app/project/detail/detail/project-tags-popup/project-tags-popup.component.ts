...
@Component({
  selector: 'app-project-tags-popup',
  templateUrl: './project-tags-popup.component.html',
  styleUrls: ['./project-tags-popup.component.scss']
})
export class ProjectTagsPopupComponent implements OnInit {
  projectId = 0;
  loading = true;
  moduleName = 'project';
  ...
  constructor(
    public dialogRef: MatDialogRef<ProjectTagsPopupComponent>,
  ...
  ngOnInit(): void {
    ...
    const allList = this.http.get(environment.baseURL + '/api/Tag/GetAllTags?module=project');
  ...
  onClick(tag: any): void{
    ...
    // this.http.post(environment.baseURL + '/api/Project/SignProject', {
