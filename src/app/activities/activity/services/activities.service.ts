...
// import { AuthType, ActivityAuthService } from "../../shared/services/auth-activity.service";
...
import { SimplestrataAuthService } from "../../shared/services/simplestrata-auth.service";
...
export class ActivitiesService {
  ...
  arabicAlertMessage: string = "تمت العملية بنجاح";
  arabicAlertErrorMessage: string = "حدث خطأ";
  ...
  getData(): { SourceSystemId: any; SourceTenantId: any; SourceObjectTypeId: any; SourceObjectId: any; } {
      let data = {
  ...
  //       !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  //     ),
  //   };
  ...
  getAllByWeeksForFollowing(
    ...
    const url = `api/IndicatorStemeXe/GetAllByWeeksForUser`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllInWeekForFollowing(
    ...
    const url = `api/IndicatorStemeXe/GetAllInWeekForUser`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getCountForClosed(
    ...
    const url = `api/IndicatorStemeXe/GetClosedCountForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
    ...
    if (!!filter.GroupInfo) {
      data.GroupInfo = {
        ...
        StartDate: filter.GroupInfo.StartDate,
        EndDate: filter.GroupInfo.EndDate,
    ...
    if(!!filter.FromFilter) {
      ...
      newFilter["GroupInfo"] = filter.GroupInfo;
      newFilter["GroupType"] = filter.GroupType;
      newFilter["IsSigned"] = filter.IsSigned;
      newFilter["StatusIds"] = filter.StatusIds;
      newFilter["ownerUserIds"] = filter.ownerUserIds;
    }
    ...
    if (!!filter) {
      ...
      if (!!filter.GroupType) {
        data.GroupType = filter.GroupType;
      }

      if (!!filter.ownerUserIds) {
        data.ownerUserIds = filter.ownerUserIds;
      }
      
      if (!!filter.IsSigned == null || filter.IsSigned || !filter.IsSigned) {
        data.IsSigned = filter.IsSigned;
      }
    }
    ...
    return this._http.post<any>(url, !forFilter ? data : newFilter, options);
  }
  ...
  getCountForMine(
    ...
    data["IsMine"] = (this.SourceSystemId || this.TeamId) ? false : true;
  ...
  getAllByGroupForMine(
    ...
    data["IsMine"] = (this.SourceSystemId || this.TeamId) ? false : true;
    if(!!data && data.StatusIds.length && data.StatusIds.indexOf(1) == -1 && (this.SourceSystemId || this.TeamId)) {
      data.StatusIds.push(1);
    }
    return this._http.post<any>(url, data, options);
  }
  ...
  getAllClosed(
    ...
    const url = `api/IndicatorStemeXe/GetAllClosedForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getCountForBacklog(
    ...
    const url = `api/IndicatorStemeXe/GetCountForBacklog`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllByGroupForBacklog(
    ...
    const url = `api/IndicatorStemeXe/GetAllForBacklog`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllForESPRequest(
    ...
    const url = `api/IndicatorStemeXe/GetAllForESPRequest`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
      ),
  ...
  getCountForESPRequest(
    ...
    const url = `api/IndicatorStemeXe/GetCountForESPRequest`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
      ),
  ...
  getStatsForESPRequest(
    ...
    // const url = `api/IndicatorStemeXe/GetStatsForESPRequest`;
    const url = `api/IndicatorStemeXe/GetStats`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
      ),
  ...
  UpdateDueDate(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/UpdateDueDate`
    //   : `api/IndicatorStemeXe/EngPro/UpdateDueDate`;
    const url = `api/IndicatorStemeXe/UpdateDueDate`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
    ...
    data["SourceSystemId"] = this.SourceSystemId;
    data["SourceTenantId"] = this.SourceTenantId;
    data["SourceObjectTypeId"] = this.SourceObjectTypeId;
  ...
  getCountForUser(
    ...
    const url = `api/IndicatorStemeXe/GetCountForUser`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllByGroupForUser(
    ...
    const url = `api/IndicatorStemeXe/GetAllForUser`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllGroupsForUser(
    ...
    const url = `api/IndicatorStemeXe/GetAllGroupsForUser`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getActivityDetails(
    ...
    // const url = !!isEpmActivity && isEpmActivity ? `api/IndicatorStemeXe/EPM/GetDetails` :
    //   isEngProActivity
    //     ? `api/IndicatorStemeXe/EngPro/GetDetails`
    //     : `api/IndicatorStemeXe/GetDetails`;
    const url = `api/IndicatorStemeXe/GetDetails`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  acceptAssigned(
    ...
    const url = `api/IndicatorStemeXe/AcceptAssigned`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  rejectAssigned(
    ...
    const url = `api/IndicatorStemeXe/RejectAssigned`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  approveReported(
    ...
    const url = `api/IndicatorStemeXe/ApproveReported`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  rejectReported(
    ...
    const url = `api/IndicatorStemeXe/RejectReported`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  signed(id: any): Observable<any> {
    const url = `api/IndicatorStemeXe/SignMultiple`
    const options = {
  ...
  rejectMultiple(id: any): Observable<any> {
    const url = `api/IndicatorStemeXe/RejectReportedMultiple`
    const options = {
      headers: this._authService.buildAuthHeader(AuthType.SimpleStrata, ''),
    };
    options.headers.append("client-id", "web");
  ...
  revokeMultiple(id: any): Observable<any> {
    const url = `api/IndicatorStemeXe/RevokeMultiple`
    const options = {
      headers: this._authService.buildAuthHeader(AuthType.SimpleStrata, ''),
    };
    options.headers.append("client-id", "web");
  ...
  updateNotes(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/UpdateNote`
    //   : `api/IndicatorStemeXe/EngPro/UpdateNote`;
    const url = `api/IndicatorStemeXe/UpdateNote`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  follow(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/Follow`
    //   : `api/IndicatorStemeXe/EngPro/Follow`;
    const url = `api/IndicatorStemeXe/Follow`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  unfollow(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/Unfollow`
    //   : `api/IndicatorStemeXe/EngPro/Unfollow`;
    const url = `api/IndicatorStemeXe/Unfollow`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  toggleImportant(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/ToggleImportant`
    //   : `api/IndicatorStemeXe/EngPro/ToggleImportant`;
    const url = `api/IndicatorStemeXe/ToggleImportant`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  delete(
    ...
    // const url = !isEngProActivity
    //   ? `api/Indicator/DoAction`
    //   : `api/IndicatorStemeXe/EngPro/DoAction`;
    const url = `api/Indicator/DoAction`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  updateActualValue(
    ...
    // const url = !isEngProActivity
    //   ? `api/Indicator/UpdateActualValue`
    //   : `api/IndicatorStemeXe/EngPro/UpdateActualValue`;
    const url = `api/Indicator/UpdateActualValue`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  create(data: any, isFromCalender?: any): Observable<any> {
    const url = `api/IndicatorStemeXe/Create`;
    const options = {
      headers: this._authService.buildAuthHeader(AuthType.SimpleStrata),
    };
    options.headers.append("client-id", "web");
    ...
    data.TacticId != null ? form.append("TacticId", data.TacticId) : ""; // SourceObjectIdLevel2
    data.SourceObjectIdLevel2 != null ? form.append("SourceObjectIdLevel2", data.SourceObjectIdLevel2) : ""; // SourceObjectIdLevel2
    ...
    if(!isFromCalender && data.StartDate != null) {
    ...
    data.SourceSystemId ? form.append("SourceSystemId", data.SourceSystemId) : form.append("SourceSystemId", data.SourceSystemId);
    data.SourceTenantId ? form.append("SourceTenantId", data.SourceTenantId) : form.append("SourceTenantId", data.SourceTenantId);
    data.SourceObjectTypeId ? form.append("SourceObjectTypeId", data.SourceObjectTypeId) : form.append("SourceObjectTypeId", data.SourceObjectTypeId);
    data.SourceObjectId ? form.append("SourceObjectId", data.SourceObjectId) : form.append("SourceObjectId", data.SourceObjectId);
  ...
  update(
    ...
    // const url = !isEngProActivity
    //   ? `api/IndicatorStemeXe/Update`
    //   : `api/IndicatorStemeXe/EngPro/Update`;
    const url = `api/IndicatorStemeXe/Update`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
    ...
    if (data.Effort !== null) {
      ...
      data.Effort.CompletedDate != null
        ? form.append("Effort.CompletedDate", data.Effort.CompletedDate)
        : "";
      data.SourceObjectIdLevel2 != null ? form.append("SourceObjectIdLevel2", data.SourceObjectIdLevel2) : "";
      data.SourceObjectIdLevel3 != null ? form.append("SourceObjectIdLevel3", data.SourceObjectIdLevel3) : "";
      data.SourceObjectTypeId != null ? form.append("SourceObjectTypeId", data.SourceObjectTypeId) : "";
      data.SourceObjectId != null ? form.append("SourceObjectId", data.SourceObjectId) : "";
    }
  ...
  searchUsers(data: any): Observable<any> {
    const url = `api/SearchApi/SearchUsers`;
    return this._http.post<any>(url, data, this._authService.ssOptions);
  }

  searchByRequest(data: any): Observable<any> {
    const url = `api/UserApi/SearchByRequest`;
    return this._http.post<any>(url, data, this._authService.ssOptions);
  }

  async getLabels(): Promise<any> {
    const url = `api/LabelGroup/GetAll`;
    return this._http.get<any>(url, this._authService.ssOptions).toPromise();
  }

  searchUnit(data: any): Observable<any> {
    const url = `api/SearchApi/SearchUnits`;
    return this._http.post<any>(url, data, this._authService.ssOptions);
  }
  ...
  //       _url = `api/IndicatorStemeXe/GetFiltersForBacklog`;
  //       return this._http.get<any>(_url, options);
  //       break;
  ...
  //       break;
  //     default:
  //       _url = `api/IndicatorStemeXe/GetFiltersForMine`;
  //       return this._http.get<any>(_url, options);
  //       break;
  //   }
  // }
  ...
  getFiltersForActiveList(
    ...
    switch (list.type) {
      ...
      case StemeXeListType.Backlog:
        _url = `api/IndicatorStemeXe/GetFiltersForBacklog`;
        return this._http.post<any>(_url, data1, options);
        break;
      case StemeXeListType.User:
        _url = `api/IndicatorStemeXe/GetFiltersForUser`;
        let data = {
  ...
  reassign(
    ...
    const url = `api/IndicatorStemeXe/Reassign`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
  ...
  getAllInWeekForMineForPaging(engProLoggedInUserId?: string, keyword?: string, pageIndex: number = 0, pageSize: number = 10): Observable<any> {
  ...
  getAllSigned(
    ...
    const url = `api/IndicatorStemeXe/GetAllSignedForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getCountForSigned(
    ...
    const url = `api/IndicatorStemeXe/GetSignedCountForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getAllRejected(
    ...
    const url = `api/IndicatorStemeXe/GetAllRejectedForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata,
        !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''
  ...
  getCountForRejected(
    ...
    const url = `api/IndicatorStemeXe/GetRejectedCountForFollowing`;
    const options = {
      headers: this._authService.buildAuthHeader(
        AuthType.SimpleStrata),
    };
  ...
  // GetCurrentWeekForMine(engProLoggedInUserId?): Observable<any> {
  //   const url = `api/IndicatorStemeXe/GetCurrentWeekForMine`;
  //   const options = {
  //     headers: this._authService.buildAuthHeader(AuthType.SimpleStrata, 
  //       !!engProLoggedInUserId ? engProLoggedInUserId.toString() :  ''),
  //   };
  ...
  GetCurrentWeekForMine(engProLoggedInUserId?: any): Observable<any> {
      const url = `api/IndicatorStemeXe/GetCurrentWeekForMine`;
      const options = {
        headers: this._authService.buildAuthHeader(AuthType.SimpleStrata),
      };
